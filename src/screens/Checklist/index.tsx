...
import FormNextSectionButton from "../../components/FormNextSectionButton";
import FormPreviousSectionButton from "../../components/FormPreviousSectionButton";
...
export default function CheckList(){
    ...
    const vehicleInfo = () => (
        <View style={styles.radioInfo}>
            ...
            {currentlySection.valueOf() === FormSection.SistemaEletrico && <>
                ...
                <View style={styles.nextSectionButton}>
                    <FormNextSectionButton 
                        nextSection={FormSection.SistemaHidraulico}
                        setNextSection={(nextSection) => setCurrentlySection(nextSection)}
                    />
                </View>
            ...
            {currentlySection.valueOf() === FormSection.SistemaHidraulico && <>
                ...
                <View style={styles.sectionButtonsContainer}>
                    <FormPreviousSectionButton 
                        previousSection={FormSection.SistemaEletrico} 
                        setPreviousSection={setCurrentlySection}
                    />
                    <FormNextSectionButton 
                        nextSection={FormSection.Geral} 
                        setNextSection={setCurrentlySection}
                    />
                </View>
            </>
            }
            
            {currentlySection.valueOf() === FormSection.Geral && <>
                ...
                <View style={styles.sectionButtonsContainer}>
                    <FormPreviousSectionButton 
                        previousSection={FormSection.SistemaHidraulico} 
                        setPreviousSection={setCurrentlySection}
                    />
                    <FormNextSectionButton 
                        nextSection={FormSection.ItensDeSeguranca} 
                        setNextSection={setCurrentlySection}
                    />
                </View>
            ...
            {currentlySection.valueOf() === FormSection.ItensDeSeguranca && <>
                ...
                <View style={styles.sectionButtonsContainer}>
                    <FormPreviousSectionButton 
                        previousSection={FormSection.Geral} 
                        setPreviousSection={setCurrentlySection}
                    />
                    <FormNextSectionButton 
                        nextSection={FormSection.ItensDeEstrutura} 
                        setNextSection={setCurrentlySection}
                    />
                </View>
            </>
            ...
            {currentlySection.valueOf() === FormSection.ItensDeEstrutura && <>
                ...
                <View style={styles.sectionButtonsContainer}>
                    <FormPreviousSectionButton 
                        previousSection={FormSection.ItensDeSeguranca} 
                        setPreviousSection={setCurrentlySection}
                    />
                    <FormNextSectionButton 
                        nextSection={FormSection.Adicionais} 
                        setNextSection={setCurrentlySection}
                    />
                </View>
            </>
            ...
            {currentlySection.valueOf() === FormSection.Adicionais && <>
                ...
                <View style={styles.previousSectionButton}>
                    <FormPreviousSectionButton 
                        ...
                        setPreviousSection={(previousSection) => setCurrentlySection(previousSection)}
                    />
                </View>
